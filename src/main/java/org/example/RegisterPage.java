...
//AssertFalse method asserts that a specified condition is false
    ...
    public void enterRegistrationDetails(){
        ...
        typeText(_firstNameField,"Jaydipsinh");
        typeText(_lastNameField,"Rathod");
        //The <select> element is used to create a drop-down list.
        selectFromDropdownByVisibleText(_DateOfBirthDateField,"21");
        selectFromDropdownByVisibleText(_DateOfBirthMonthField,"March");
        selectFromDropdownByVisibleText(_DateOfBirthYear,"1990");
        typeText(_emailField,"Jaydip" +getTimeStamp()+"@gmail.com");
        typeText(_CompanyField,"DP Company");
        clickOnElement(_NewsLetterField);
        typeText(_PasswordField,"Jaydip");
        typeText(_ConfirmPassword,"Jaydip");
